(* ========================================================================== *)
(*  04_response_defs  (5 eV threshold)
*)
(*  Response-function definitions: expected rate Exprate (+resolution variants), differential responses CurlR/CurlRbox and the CRloop builders; CurlRboxG/CurlRG do the recoil integral once per bin with Ev kept as a parameter. The per-bin response functions themselves are built in 06_response_functions. From Functions.nb, ExpRate.nb.
*)
(* ========================================================================== *)
